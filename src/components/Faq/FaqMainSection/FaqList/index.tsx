...
– Wypełnione oświadczenie obozowe (należy je wypełnić zgodnie z prawdą i zabrać ze sobą na odprawę!)/n 
– Wydrukowane potwierdzenie dokonania wpłaty lub przekazu pocztowego (dla własnej pewności)/n 
...
– Ważna legitymacja studencka"
			...
			<AccordeonItem
				...
				answer="Odprawa obozowa jest planowana na czwartek, 4 listopada 2021r 13.00./n
...
Uczestników informujemy, że na odprawie obozowej mogą pojawić się władze Wydziału Fizyki Technicznej, Informatyki i Matematyki Stosowanej. Osoby, które stawią się w miejscu zbiórki i odprawy w stanie wskazującym na spożycie alkoholu lub środków odurzających, będą w trybie natychmiastowym wydalane z Wyjazdu jeszcze przed wyjazdem z Łodzi bez możliwości ubiegania się Uczestnika o zwrot kosztów. W trakcie trwania Delta 2021 przewidywana jest również wizytacja Władz Uczelni, Wydziału oraz przedstawicieli Politechniki Łódzkiej."
			...
			<AccordeonItem
				...
				answer="Zgodnie z Regulaminem, w razie rezygnacji z uczestnictwa w wyjeździe do dnia 10.10.2021 r. przysługuje Państwu zwrot całości wpłaconej kwoty. Rezygnacje w późniejszym terminie będą rozpatrywane indywidualnie, w zależności od podanego powodu rezygnacji. Czynność taka koniecznie musi być sygnalizowana Organizatorowi mailowo na adres delta@samorzad.p.lodz.pl i Głównemu Koordynatorowi k.sobiecki@samorzad.p.lodz.pl. Mail powinien zawierać: imię, nazwisko, nr telefonu kontaktowego, wszelkie dane związane z numerem konta bankowego, na który ma przyjść przelew zwrotny (m.in. numer konta, nazwa właściciela, adres nie jest konieczny) oraz ponownie załączone potwierdzenie wpłaty i powód rezygnacji. W przypadku rezygnacji dopuszczalne jest również przekazanie swojego opłaconego miejsca innej osobie. Procedura wykonywania zwrotów zostanie uruchomiona dn. 17.10.2021 r., a czas jej realizacji może wynosić nawet do 30 dni roboczych."
			/>
			<AccordeonItem
				num={5}
